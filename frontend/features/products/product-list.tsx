...
export function ProductList() {
    ...
    const change = (key: string, value: string) => { const next = new URLSearchParams(query); if (value)
        ...
        next.set('page', '1'); router.replace('/admin/productos?' + next, { scroll: false }); };
